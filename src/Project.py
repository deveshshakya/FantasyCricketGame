...
from src.evaluateWindow import Ui_EvaluateWindow
from src.newWindow import Ui_NewWindow
from src.openWindow import Ui_OpenWindow
...
class Ui_MainWindow(object):
    ...
    def saveFile(self):
        ...
        Team = sqlite3.connect('../db/TEAM.db')
        cursor = Team.cursor()
    ...
    def MatchName_dropdown_changer(self):
        ...
        Match = sqlite3.connect("../db/MATCH.db")
    ...
    def openClicked(self):
        ...
        try:
            ...
            Team = sqlite3.connect('../db/TEAM.db')
            cursor = Team.cursor()
            Players = sqlite3.connect("../db/PLAYERS.db")
